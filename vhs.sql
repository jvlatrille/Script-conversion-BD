...
(50),
    idUtilisateur INT,
    FOREIGN KEY
(idUtilisateur) REFERENCES vhs_utilisateur
(idUtilisateur) ON
DELETE
SET NULL
);
...
(255) NOT NULL,
    numero INT NOT NULL,
    nvDifficulte VARCHAR
(25),
    bonneReponse VARCHAR
(150),
    idOa INT,
    FOREIGN KEY
(idOa) REFERENCES vhs_oa
(idOa) ON
DELETE
SET NULL
);
...
CREATE TABLE vhs_repondre (
    idRepondre INT PRIMARY KEY AUTO_INCREMENT,
    idQuizz INT,
    idUtilisateur INT,
    score INT DEFAULT 0,
    UNIQUE
(idQuizz, idUtilisateur),
    FOREIGN KEY
(idQuizz) REFERENCES vhs_quizz
(idQuizz) ON
DELETE CASCADE,
    FOREIGN KEY(idUtilisateur)
REFERENCES vhs_utilisateur
(idUtilisateur) ON
DELETE CASCADE
);
